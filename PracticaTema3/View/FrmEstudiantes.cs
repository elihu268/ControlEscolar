        ...
        private void CargarEstudiantes()
        {
            try
            {
                ...
                List<Estudiante> estudiantes = estudiantesController.ObtenerEstudiantes(
                    ...
                    fechaInicio: dtpFechaInicio.Enabled ? null : (DateTime?)null,
                    fechaFin: dtpFechaFin.Enabled ? null : (DateTime?)null
                 );
    ...
    "Información del sistema", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void ActualizarEstudiante()
        {
            try
            {
                ...
                if (cmbEstatus.SelectedIndex == 0) // Si el estatus es "Baja"
                {
